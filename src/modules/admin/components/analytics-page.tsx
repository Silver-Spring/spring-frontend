            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span>
                    {completedCount} completed ({filterLabel})
                  </span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span>{inProgressCount} in progress ({filterLabel})</span>
                </div>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span>{isAllTypes ? 'Across filtered sessions' : 'For selected type'}</span>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Completion over the last 7 days ({filterLabel})
                </CardDescription>
              </CardHeader>
              <CardContent>
                {loadingTrends ? (
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {isAllTypes
                    ? 'Select a specific type to view score ranges'
                    : 'View score ranges and patterns'}
                </CardDescription>
              </CardHeader>
              <CardContent>
                {isAllTypes ? (
                  <div className="flex items-center justify-center h-[300px] text-muted-foreground text-center px-6">
                    Score distribution is available per assessment type. Choose SSRI, PRAI, or
                    another type above.
                  </div>
                ) : isChartsLoading ? (
                  <div className="flex items-center justify-center h-[300px]">
